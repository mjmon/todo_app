  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<TaskBloc, TaskState>(
      ...
      builder: (context, state) {
        ...
        final allTaskList = state.allTaskList;
        final activeTaskList = state.activeTaskList;
        final completedTaskList = state.completedTaskList;
            ...
            itemBuilder: ((context, index) {
              ...
              return TaskItem(
                ...
                onCompleteToggle: (bool? newValue) {
                  ...
                  final updatedTask =
                      task.copyWith(isComplete: newValue ?? false);
                  context
                      .read<TaskBloc>()
                      .add(TaskEvent.update(task: updatedTask));
                },
                onView: () {
                  // Edit the task
                  Navigator.push(
